...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    //capturing incoming request and check is there any token present
    @Override
    ...
    //validation of the token presence with our request
...
// we are using the same SECRET we used in JWT generation to validate incoming authentication token.
// Then verify it. Then If verification is successful It will return a UsernamePasswordAuthenticationToken, and authorization will be successfully completed.
